...
export const ConcernDetail: React.FC<ConcernDetailProps> = ({
  ...
  // Detect AI-generated concerns. Prefer explicit flag if present, otherwise check explanation prefix.
  const isAIGenerated = (concern as any).aiGenerated === true || (typeof concern.explanation === 'string' && concern.explanation.startsWith('(AI-generated)'))
                  ...
                  >
                    ...
                    >
                      {getCategoryLabel(concern.category)}
                                    ...
                                    {/* AI-generated badge */}
                                    {isAIGenerated && (
                                      <AccessibleTooltip content="Generated by AI" type="info">
                                        <Badge variant="secondary" className="text-xs" aria-label="AI generated concern">
                                          AI
                                        </Badge>
                                      </AccessibleTooltip>
                                    )}
